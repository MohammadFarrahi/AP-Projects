...
enum ArgumentIndex { A_username, A_email, A_password, A_amount, A_count, A_id, A_type,
...
const std::vector<std::string> ARGUMENTS = {"username", "email", "password", "amount", "count", "id", "type", "quantity",
...
const std::vector<std::string> FILTER_ARGUMENTS = {"city", "min_star", "max_star", "min_price", "max_price", "type", "quantity",
